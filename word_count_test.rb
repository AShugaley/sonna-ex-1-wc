...
class WordCountTest < Minitest::Test
  ...
  def test_everything_all_at_once
    #skip
    phrase = Phrase.new(" This pHRAse containts every' single &&&& issue#  let's,see,how this 'solU$tion' will; handle it''' '")
    counts = {"this"=>2, "phrase"=>1, "containts"=>1, "every"=>1, "single"=>1, "issue"=>1, "let's"=>1, "see"=>1, "how"=>1, "solution"=>1, "will"=>1, "handle"=>1, "it"=>1}
    assert_equal counts, phrase.word_count
  end
end
